...
function Search({ query, setEntities, recordEvent }: any) {
  ...
  return (
    <div className="bg-white w-full sm:w-3/4 mx-auto">
      {/* Mobile menu */}
      <main className="pb-24">
        <div className="text-left sm:pb-4 pb-6 px-4 sm:px-0 lg:px-0">          
          <h4 className="text-sm mt-2 font-medium tracking-tight text-gray-500 sm:h-6">
        ...
        <div className="grid sm:grid-cols-12 grid-cols-1 gap-1 overflow-hidden sm:px-0 lg:px-0 px-4">
