          ...
          <div className="flex-col w-full px-5 py-5 flex items-center justify-center">
            ...
            <div className="mt-10 flex sm:flex-col1">
              <button
                ...
                className="max-w-xs flex-1 bg-orange border-2 border-black rounded-sm py-3 px-8 flex items-center justify-center font-medium text-black hover:text-white hover:bg-orange focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-500 sm:w-full"
              >
                {BTN_CHECKOUT_SECURELY}
              </button>
            </div>
