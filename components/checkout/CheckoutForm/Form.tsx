          ...
          <>
                  ...
                  >
                    <div>
                      {item.id === defaultValues.id ? (
                        <CheckCircleIcon
                          className="h-5 pr-4 text-left align-left text-orange"
                          aria-hidden="true"
                        />
                      ) : null}
                      {item.id !== defaultValues.id ? (
                    ...
                    >
                      ...
                      {formItem.addressFinder && itemsToHide.length > 0 ? (
                        <button
                          ...
                          style={{ maxWidth: '20%' }}
                          className="ml-3 mt-8 mb-8 max-w-xs flex-1 bg-orange border-2 border-black rounded-sm py-2 px-1 flex items-center justify-center font-medium hover:text-white text-black hover:bg-orange focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-500 sm:w-full"
                        >
                          {BTN_FIND}
                        </button>
                      ) : null}
            ...
            {!isGuest && (
              <div className="flex">
                <button
                  ...
                  className="max-w-xs m-2 flex-1 bg-orange border-2 border-black rounded-sm py-3 px-8 flex items-center justify-center font-medium hover:text-white text-black hover:bg-orange focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-500 sm:w-full"
                >
            ...
            {isSameAddressCheckboxEnabled && (
              <div className="flex items-center mt-10">
                <input
                  ...
                  className="h-4 w-4 border-gray-300 rounded text-orange focus:ring-indigo-500"
                />
                <label
                  htmlFor={`sameAddress`}
            ...
            <div className="mt-10 flex sm:flex-col1 w-full justify-center">
              <button
                ...
                className="max-w-xs flex-1 bg-orange border-2 border-black rounded-sm py-3 px-8 flex items-center justify-center font-medium hover:text-white text-black hover:bg-orange focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-500 sm:w-full"
              >
                {btnTitle}
              </button>
              {!!closeEditMode && (
